...
{
    /// <inheritdoc />
    public partial class CreateNewTableAndUpdateTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleLicense = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryCost = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodsOrderItems", x => new { x.FoodsId, x.OrderItemsId });
                    table.ForeignKey(
                        name: "FK_FoodsOrderItems_Foods_FoodsId",
                        column: x => x.FoodsId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodsOrderItems_OrderItems_OrderItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodsOrderItems_OrderItemsId",
                table: "FoodsOrderItems",
                column: "OrderItemsId");
